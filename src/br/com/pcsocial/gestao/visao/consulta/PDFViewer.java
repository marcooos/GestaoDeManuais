...
public class PDFViewer extends JFrame
    ...
    ZoomAction zoomInAction = new ZoomAction("Zoom in",
    		new ImageIcon(getClass().getResource("/gui/gfx/zoomin.gif")),
            2.0);
    ...
    Action fullScreenAction = new AbstractAction("Full screen",
            new ImageIcon(getClass().getResource("/gui/gfx/fullscrn.gif"))) {

        public void actionPerformed(ActionEvent evt) {
            doFullScreen((evt.getModifiers() & evt.SHIFT_MASK) != 0);
        }
    };
    Action nextAction = new AbstractAction("Next", new ImageIcon(getClass().getResource("/gui/gfx/next.gif"))) {

        public void actionPerformed(ActionEvent evt) {
            doNext();
        }
    };
    Action firstAction = new AbstractAction("First", new ImageIcon(getClass().getResource("/gui/gfx/first.gif"))) {

        public void actionPerformed(ActionEvent evt) {
            doFirst();
        }
    };
    Action lastAction = new AbstractAction("Last", new ImageIcon(getClass().getResource("/gui/gfx/last.gif"))) {

        public void actionPerformed(ActionEvent evt) {
            doLast();
        }
    };
    Action prevAction = new AbstractAction("Prev", new ImageIcon(getClass().getResource("/gui/gfx/prev.gif"))) {
...
//        System.out.println("Going to page " + pagenum);
     ...
     * @param path
     */
    private void openPDFByteBuffer(ByteBuffer buf, String path, String name,int pagina) {
